...
- Token : cblrs-openclaw-bunker-2026
...
- Cle : sk-or-v1-7b83...1406d2 (voir CREDENTIALS/)
...
- Nouveau user BDD : staging_user / Stg!Cblrs2026_QC#Secure (SELECT/INSERT/UPDATE)
...
- [ ] Peupler regions, stages, localities (extraire des GPX .rar des 305 routes)
